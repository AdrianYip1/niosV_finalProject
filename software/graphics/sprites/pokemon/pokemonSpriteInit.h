...
#define POKEMON_ID_RAYQUAZA   4
#define POKEMON_ID_GARCHOMP   5
#define POKEMON_ID_LUCARIO    6
#define POKEMON_ID_MILOTIC    7
#define POKEMON_ID_ROSERADE   8
#define POKEMON_ID_SPIRITOMB  9
#define POKEMON_ID_TOGEKISS   10
#define POKEMON_ID_BUDEW      11
#define POKEMON_ID_FEEBAS     12
#define POKEMON_ID_GIBLE      13
#define POKEMON_ID_GABITE     14
#define POKEMON_ID_RIOLU      15
#define POKEMON_ID_TOGEPI     16
#define POKEMON_ID_TOGETIC    17

#define POKEMON_ID_MAX        POKEMON_ID_TOGETIC
