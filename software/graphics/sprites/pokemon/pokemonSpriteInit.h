...
#define POKEMON_ID_GIBLE      4
#define POKEMON_ID_GABITE     5
#define POKEMON_ID_GARCHOMP   6
#define POKEMON_ID_FEEBAS     7
#define POKEMON_ID_MILOTIC    8
#define POKEMON_ID_RIOLU      9
#define POKEMON_ID_LUCARIO    10
#define POKEMON_ID_BUDEW      11
#define POKEMON_ID_ROSERADE   12
#define POKEMON_ID_TOGEPI     13
#define POKEMON_ID_TOGETIC    14
#define POKEMON_ID_TOGEKISS   15
#define POKEMON_ID_SPIRITOMB  16
#define POKEMON_ID_RAYQUAZA   17

#define POKEMON_ID_MAX        POKEMON_ID_RAYQUAZA
