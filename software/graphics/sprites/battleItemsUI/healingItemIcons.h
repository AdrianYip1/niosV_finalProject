...
#define HEALING_ITEM_ICON_WIDTH  24
#define HEALING_ITEM_ICON_HEIGHT 24
#define HEALING_ITEM_ICON_COUNT  6
...
extern const unsigned short healingItemIcon_revive[HEALING_ITEM_ICON_WIDTH * HEALING_ITEM_ICON_HEIGHT];
extern const unsigned short healingItemIcon_maxRevive[HEALING_ITEM_ICON_WIDTH * HEALING_ITEM_ICON_HEIGHT];
