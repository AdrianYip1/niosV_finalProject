...
#define POKEBALL_ICON_WIDTH  14
#define POKEBALL_ICON_HEIGHT 14
#define POKEBALL_ICON_COUNT  5
...
extern const unsigned short pokeballIcon_master[POKEBALL_ICON_WIDTH * POKEBALL_ICON_HEIGHT];
