...
extern const short house_top_left_tile[TILE_SIZE * TILE_SIZE];
extern const short house_top_middle_tile[TILE_SIZE * TILE_SIZE];
extern const short house_top_right_tile[TILE_SIZE * TILE_SIZE];
extern const short house_middle_left_tile[TILE_SIZE * TILE_SIZE];
extern const short house_middle_middle_tile[TILE_SIZE * TILE_SIZE];
extern const short house_middle_right_tile[TILE_SIZE * TILE_SIZE];
extern const short house_bottom_left_tile[TILE_SIZE * TILE_SIZE];
extern const short house_bottom_middle_tile[TILE_SIZE * TILE_SIZE];
extern const short house_bottom_right_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_top_left_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_top_middle_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_top_right_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_middle_left_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_middle_middle_tile[TILE_SIZE * TILE_SIZE];
extern const short gym_middle_right_tile[TILE_SIZE * TILE_SIZE];
