...
#define BATTLE_ICON_BAG_Y   (BATTLE_ICON_PANEL_BOTTOM_Y - BATTLE_ICON_SMALL_HEIGHT)
#define BATTLE_ICON_RUN_X   (BATTLE_ICON_STACK_X)
#define BATTLE_ICON_RUN_Y   (BATTLE_ICON_BAG_Y - BATTLE_ICON_GAP_Y - BATTLE_ICON_SMALL_HEIGHT)
