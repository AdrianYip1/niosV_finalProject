...
#define BATTLE_ICON_MARGIN_LEFT 8
#define BATTLE_ICON_MARGIN_BOTTOM 8
#define BATTLE_ICON_GAP_X 10
#define BATTLE_ICON_GAP_Y 6

#define BATTLE_ICON_PANEL_BOTTOM_Y (TEXTBOX_Y - BATTLE_ICON_MARGIN_BOTTOM)

#define BATTLE_ICON_FIGHT_X (BATTLE_ICON_MARGIN_LEFT)
#define BATTLE_ICON_FIGHT_Y (BATTLE_ICON_PANEL_BOTTOM_Y - BATTLE_ICON_FIGHT_HEIGHT)

#define BATTLE_ICON_STACK_X (BATTLE_ICON_FIGHT_X + BATTLE_ICON_FIGHT_WIDTH + BATTLE_ICON_GAP_X)
#define BATTLE_ICON_BAG_X   (BATTLE_ICON_STACK_X)
#define BATTLE_ICON_RUN_X   (BATTLE_ICON_STACK_X)

// Stack (bag on top, run on bottom), centered vertically relative to the fight icon.
#define BATTLE_ICON_STACK_TOTAL_H (BATTLE_ICON_SMALL_HEIGHT + BATTLE_ICON_GAP_Y + BATTLE_ICON_SMALL_HEIGHT)
#define BATTLE_ICON_STACK_TOP_Y   (BATTLE_ICON_FIGHT_Y + ((BATTLE_ICON_FIGHT_HEIGHT - BATTLE_ICON_STACK_TOTAL_H) / 2))
#define BATTLE_ICON_BAG_Y         (BATTLE_ICON_STACK_TOP_Y)
#define BATTLE_ICON_RUN_Y         (BATTLE_ICON_STACK_TOP_Y + BATTLE_ICON_SMALL_HEIGHT + BATTLE_ICON_GAP_Y)
