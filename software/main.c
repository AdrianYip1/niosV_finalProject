...
// Battle icon layout (explicit per-icon positions).
// - Bag/Run stack is 5px to the right of Fight
// - Fight bottom is 3px above the textbox top edge
#define BATTLE_ICON_FIGHT_X 13
#define BATTLE_ICON_FIGHT_Y (TEXTBOX_Y - 3 - BATTLE_ICON_FIGHT_HEIGHT)

#define BATTLE_ICON_BAG_X (BATTLE_ICON_FIGHT_X + BATTLE_ICON_FIGHT_WIDTH + 5)
#define BATTLE_ICON_BAG_Y (BATTLE_ICON_FIGHT_Y)

#define BATTLE_ICON_RUN_X (BATTLE_ICON_BAG_X)
#define BATTLE_ICON_RUN_Y (TEXTBOX_Y - BATTLE_ICON_SMALL_HEIGHT)
