...
#define BATTLE_ICON_BAG_Y         (BATTLE_ICON_STACK_TOP_Y + 1)
#define BATTLE_ICON_RUN_Y         (BATTLE_ICON_STACK_TOP_Y + BATTLE_ICON_SMALL_HEIGHT + BATTLE_ICON_GAP_Y - 10)
