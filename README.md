...
A Pokemon RPG written from scratch in C, running bare metal on a NiosV soft processor on the DE1-SoC. No operating system, no game engine, or libraries. The graphics are raw RGB565 pixels pushed into a double buffered VGA framebuffer at a steady 20 fps, the controls come from a PS/2 keyboard driver, and the music and sound with audio interrupts. 

This was our final project for ECE243 (Computer Organization) at the University of Toronto.

Built with [AnRi1202](https://github.com/AnRi1202): I did the game engine, rendering, and animations, he did the maps, audio, and PS/2 input.
...
Built for ECE243 at the University of Toronto. Pokemon is a trademark of Nintendo / Game Freak. 
